            ...
            <div class="col-lg-6">
                <div class="tm-card blog-create-section">
                    ...
                    <div class="multiple-file-upload tm-upload-inline">
                        <input type="file" class="filepond file-upload-multiple" id="filepond" multiple data-allow-reorder="true" data-max-file-size="100MB" data-max-files="5">
                    </div>
                    <ul class="tm-doclist mt-2">
                        @foreach($all_documents ?? [] as $item)
                            <li>
                                ...
                                <a href="{{ url('activities/delete_uploaded_file_view/'.$item->id) }}" onclick="return confirm('Are you sure you want to delete this file?')" title="Delete File" class="tm-doc-del">
