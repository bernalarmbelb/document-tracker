    ...
    <div class="tm-page">
        ...
        <div class="tm-page-head">
            ...
            <div class="d-flex align-items-center" style="gap:10px;flex-wrap:wrap">
                ...
                @endif
                <a href="{{ url('ordinances/view_pdf/'.$info->id) }}" target="_blank" class="tm-btn tm-btn-secondary">
...
<script>
    ...
    const ordinanceId = {{ $info->id }};
    const uploadUrl = '{{ url("/ordinances/upload_supporting_documents") }}';
    const filesUrl = '{{ url("ordinances/get_uploaded_files") }}';
    const deleteBaseUrl = '{{ url("ordinances/delete_uploaded_file_view") }}';

    function refreshSupportingDocuments() {
        $.ajax({
            type: 'POST', data: { ordinance_id: ordinanceId }, dataType: "json",
            url: filesUrl,
    ...
    function initFilePondView() {
        ...
        filepondView = FilePond.create(input, {
            ...
            `,
            server: {
                process: uploadUrl + '?ordinance_id=' + ordinanceId,
                headers: {
