...
<div class="layout-px-spacing">
    <div class="tm-page">
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-6">
                <div class="tm-card">
                    <form class="row g-3" action="{{ $edit ? url('/ordinances/save_changes/') : url('/ordinances/save_add/') }}" method="post" autocomplete="off">
                        @csrf
                ...
                <div class="tm-card">
                    ...
                    <div id="editor-container" style="height: 500px;">
                        <p class="ql-align-center">
                            <img src="https://cdn.jsdelivr.net/gh/passam22/doc_tracker_assets/letter_head_ordinance.PNG" alt="Letter Head" style="height: 40px;">
                        </p>
                        <br/>
...
<script>
    ...
    const toolbarOptions = [
        ...
        FilePond.create(document.getElementById('filepond'), {
            ...
            storeAsFile: true,
            server: {
                process: '{{ url("/ordinances/upload_supporting_documents?ordinance_id=$info->id") }}', 
                headers: {
