...
<div class="layout-px-spacing">
    <div class="tm-page">
        <div class="tm-page-head">
            <div><h1 class="tm-title">Archive</h1><div class="tm-crumb"><a href="{{ url('dashboard') }}">Home</a> / Archive / Ordinances</div></div>
        </div>

        @include('archive.partials.tabs', ['active' => 'ordinances'])

        <div class="tm-card">
            <table id="zero-config" class="tm-table" style="width:100%">
                <thead>
                    <tr>
                        <th>Ordinance No.</th><th>Approved Date</th><th>Short Title</th><th>Author</th><th>Subject Matter</th>
                        <th>Source Book No.</th><th>Status</th><th>SP Resolutions</th><th>Publication/Posting</th><th>Keywords/Tags</th><th>Type</th><th class="no-content">Actions</th>
                    </tr>
                </thead>
                <tbody>
