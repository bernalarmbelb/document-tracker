    ...
    <div class="tm-page">
        ...
        <div class="tm-page-head">
            ...
            <div class="d-flex align-items-center" style="gap:10px;flex-wrap:wrap">
                ...
                @endif
                <a href="{{ url('minutes/view_pdf/'.$info->id) }}" target="_blank" class="tm-btn tm-btn-secondary">
...
<script>
    ...
    const minuteId = {{ $info->id }};
    const uploadUrl = '{{ url("/minutes/upload_supporting_documents") }}';
    const filesUrl = '{{ url("minutes/get_uploaded_files") }}';
    const deleteBaseUrl = '{{ url("minutes/delete_uploaded_file_view") }}';

    function refreshSupportingDocuments() {
        $.ajax({
            type: 'POST', data: { minute_id: minuteId }, dataType: "json",
            url: filesUrl,
            success: function (data) {
                ...
                items.forEach(item => {
                    ...
                    a.href = "{{ url('uploads_minutes') }}/" + item.filename;
    ...
    function initFilePondView() {
        ...
        filepondView = FilePond.create(input, {
            ...
            `,
            server: {
                process: uploadUrl + '?minute_id=' + minuteId,
                headers: {
