...
{
    /**
     * @param array $rows    list of ['member_id'=>int, 'status'=>'P'|'A'|'OB'|'LV']
    ...
    {
        $counts = []; // member_id => ['P'=>..,'A'=>..,'OB'=>..,'LV'=>..]
        foreach ($members as $m) {
            $counts[$m['id']] = ['P' => 0, 'A' => 0, 'OB' => 0, 'LV' => 0];
        }

        $totals = ['sessions' => $sessionCount, 'P' => 0, 'A' => 0, 'OB' => 0, 'LV' => 0];
